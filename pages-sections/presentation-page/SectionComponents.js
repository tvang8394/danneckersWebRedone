...
import grocerStoryImage from "assets/img/assets-for-demo/presentationViewSectionComponent/grocerystore.svg";
      ...
      <div className={classes.container}>
        <GridContainer justify="center">
          <GridItem md={5} lg={5} sm={12} xs={12}>
            <h3 className={classes.title}>New Updates</h3>
            <h6 className={classes.description}>
              Take a look at whats new and whats coming!
            </h6>
